...
pub fn handleControlPlaneCommand(
    ...
    const raw_response_json = switch (control_type) {
        ...
        .workspace_create => try runtime_registry.control_plane.createWorkspace(payload_json),
        .workspace_update => try runtime_registry.control_plane.updateWorkspaceWithRole(payload_json, is_admin),
        .workspace_delete => try runtime_registry.control_plane.deleteWorkspaceWithRole(payload_json, is_admin),
        .workspace_list => try runtime_registry.control_plane.listWorkspaces(),
        .workspace_get => try runtime_registry.control_plane.getWorkspaceWithRole(payload_json, is_admin),
        ...
        .workspace_mount_set => try runtime_registry.control_plane.setWorkspaceMountWithRole(payload_json, is_admin),
        .workspace_mount_remove => try runtime_registry.control_plane.removeWorkspaceMountWithRole(payload_json, is_admin),
        .workspace_mount_list => try runtime_registry.control_plane.listWorkspaceMountsWithRole(payload_json, is_admin),
        .workspace_bind_set => try runtime_registry.control_plane.setWorkspaceBindWithRole(payload_json, is_admin),
        .workspace_bind_remove => try runtime_registry.control_plane.removeWorkspaceBindWithRole(payload_json, is_admin),
        .workspace_bind_list => try runtime_registry.control_plane.listWorkspaceBindsWithRole(payload_json, is_admin),
        .workspace_token_rotate => try runtime_registry.control_plane.rotateWorkspaceTokenWithRole(payload_json, is_admin),
        .workspace_token_revoke => try runtime_registry.control_plane.revokeWorkspaceTokenWithRole(payload_json, is_admin),
        .workspace_activate => try runtime_registry.control_plane.activateWorkspaceWithRole(agent_id, payload_json, is_admin),
        ...
        .workspace_up => try runtime_registry.control_plane.workspaceUpWithRole(agent_id, payload_json, is_admin),
        .audit_tail => try runtime_registry.buildAuditTailPayload(payload_json),
        .packages_list => try runtime_registry.control_plane.listVenomPackages(),
        .packages_catalog => try runtime_registry.control_plane.listRegistryCatalog(payload_json),
        .packages_updates => try runtime_registry.control_plane.listVenomPackageUpdates(),
        .packages_update => try runtime_registry.control_plane.updateVenomPackage(payload_json),
        .packages_update_all => try runtime_registry.control_plane.updateVenomPackagesBatch(payload_json),
        .packages_get => try runtime_registry.control_plane.getVenomPackage(payload_json),
        .packages_channel_get => try runtime_registry.control_plane.getRegistryChannelPolicy(payload_json),
        .packages_channel_set => try runtime_registry.control_plane.setRegistryChannelPolicy(payload_json),
        .packages_channel_clear => try runtime_registry.control_plane.clearRegistryChannelPolicy(payload_json),
        .packages_install => try runtime_registry.control_plane.installVenomPackage(payload_json),
        .packages_enable => try runtime_registry.control_plane.enableVenomPackage(payload_json),
        .packages_switch => try runtime_registry.control_plane.switchVenomRelease(payload_json),
        .packages_disable => try runtime_registry.control_plane.disableVenomPackage(payload_json),
        .packages_rollback => try runtime_registry.control_plane.rollbackVenomPackage(payload_json),
        .packages_remove => try runtime_registry.control_plane.removeVenomPackage(payload_json),
