...
pub const LocalNodeSupervisor = struct {
    ...
    fn buildManifestJson(self: *LocalNodeSupervisor, venom_id: []const u8, mode: []const u8) ![]u8 {
        ...
        return std.fmt.allocPrint(
            self.allocator,
            "{{\"venom_id\":\"{s}\",\"package_id\":\"{s}\",\"kind\":\"{s}\",\"version\":\"1\",\"state\":\"online\",\"provider_scope\":\"node_export\",\"categories\":{s},\"host_roles\":[\"node\"],\"hosts\":[\"node\"],\"binding_scopes\":[\"workspace\"],\"projection_modes\":[\"node_export\",\"workspace_service\"],\"requirements\":{s},\"runtime_kind\":\"native\",\"endpoints\":[\"/nodes/{{node_id}}/venoms/{s}\"],\"mounts\":[{{\"mount_id\":\"{s}\",\"mount_path\":\"/nodes/{{node_id}}/venoms/{s}\",\"state\":\"online\"}}],\"capabilities\":{s},\"ops\":{{\"model\":\"namespace\",\"invoke\":\"control/invoke.json\",\"paths\":{{\"invoke\":\"control/invoke.json\"}}}},\"runtime\":{{\"type\":\"native_proc\",\"abi\":\"namespace-driver-v1\",\"executable_path\":\"{s}\",\"args\":[\"{s}\",\"{s}\"],\"timeout_ms\":300000}},\"permissions\":{{\"default\":\"allow-by-default\",\"allow_roles\":[\"admin\",\"user\"],\"scope\":\"project\"}},\"schema\":{{\"model\":\"namespace-mount\"}},\"invoke_template\":{s},\"help_md\":\"{s}\"}}",
            .{
                venom_id,
                venom_id,
                kind,
