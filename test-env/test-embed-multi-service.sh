...
# - probes /fs via spiderweb-fs-mount
...
ENDPOINT="a=ws://$BIND_ADDR:$PORT/fs#work"
...
log_info "Waiting for /fs readiness..."
ready=0
...
if [[ "$ready" -ne 1 ]]; then
    log_fail "Timed out waiting for /fs readiness"
